...
import { View, Text, StyleSheet, SafeAreaView, ScrollView, Image, FlatList, TouchableOpacity, ImageBackground } from 'react-native';
        ...
        <SafeAreaView style={styles.safeArea}>
            <ScrollView style={styles.container}>
                ...
                <View style={styles.bannerContainer}>
                    ...
                    <ImageBackground source={{ uri: BANNER_DATA.image }} style={styles.bannerImage} imageStyle={{ borderRadius: 12 }}>
                        <View style={styles.bannerOverlay}>
                            <Text style={styles.bannerTitle}>{BANNER_DATA.title}</Text>
